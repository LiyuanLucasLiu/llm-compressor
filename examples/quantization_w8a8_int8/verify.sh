...
python apply_profile.py --model "deepseek-ai/DeepSeek-R1-Distill-Qwen-7B" --quantized_model ./DeepSeek-R1-Distill-Qwen-7B-W8A8-Dynamic-Per-Token --profile ./profile/qwen7b-r1.pt --save_to DeepSeek-R1-Distill-Qwen-7B-W8A8-onthefly-stable-fixround
